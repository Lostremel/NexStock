...
function toggleTheme() {
  ...
  localStorage.setItem('isabela-theme', newTheme);
...
function calcularReceitaTotal() {
  ...
  clientesData.forEach(cliente => {
    ...
    } else if (cliente.statusPagamento === 'pago') {
...
/**
 * Abre um modal de entrada genérico para substituir o prompt()
 * @param {Object} options - { title, label, prefix, type, placeholder, onConfirm }
 */
function openInputModal(options) {
  ...
  fieldEl.value = options.type === 'hidden' ? 'CONFIRMAR' : '';
